...
export default function EditProject() {
  ...
  useEffect(() => {
    (async () => {
      ...
      setProject(u);
      const { data: m } = await api.get(`/user`);
      setUsers(m);
      console.log(u.members);
    })();
  }, []);
              ...
              <React.Fragment>
                ...
                <div className="py-3 px-4">
                  ...
                  <div className="w-full">
                      <div className="text-[14px] text-[#212325] font-medium	">Members</div>
                      <Select
                        className="projectsInput text-[14px] font-normal text-[#212325] rounded-[10px] before:!content-[none]"
                        name="members"
                        multiple
